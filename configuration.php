...
class JConfig
{
	...
	public $db = 'jomla_express';
	public $dbencryption = false;
	public $dbprefix = 'tx6xv_';
	public $dbsslca = '';
	public $dbsslcert = '';
	public $dbsslcipher = '';
	public $dbsslkey = '';
	...
	public $log_path = 'C:/xampp/htdocs/jomla_express/administrator/logs';
	public $log_priorities = array (
'0' => 'all'
);
	public $mailer = 'mail';
	public $mailfrom = '55555kelompok@gmail.com';
	public $mailonline = '1';
	public $massmailoff = '';
	...
	public $replytoname = '';
	public $robots = '';
	public $secret = 'aGXMob8XoyiikYUW1NZrS3XfkFFzge8X';
	public $sef = '1';
	public $sef_rewrite = '';
	public $sef_suffix = '';
	...
	public $smtpuser = '';
	public $tmp_path = 'C:/xampp/htdocs/jomla_express/tmp';
	public $unicodeslugs = '';
	public $user = 'root';
}
