...
class pkg_jollyanyInstallerScript {
   ...
   public function displayAstroidWelcome($parent) {
      ...
      <div class="astroid-install">
         <img src="<?php echo Uri::root() . 'media/templates/site/tz_express/images/banner.png'; ?>" alt="astroid-logo" />
         <div class="install-message">
            <h3>Express - Newspaper & News Joomla Template
         ...
         <div class="astroid-support-link">
            <a href="https://docs.jollyany.co/" target="_blank">Documentation</a> <span>|</span> <a href="https://1.envato.market/zODvW" target="_blank">Changelog</a> <span>|</span> <a href="https://www.templaza.com/forums.html" target="_blank">Forum</a>
         </div>
      </div>
      <?php
   }
